...
it('shows the complete package image, facility carousel, capacity, and normalized whatsapp link', function () {
    ...
    $this->get(route('package.detail', $package))
        ...
        ->assertSee('public-carousel__btn facility-carousel__button--prev', false)
        ->assertSee('public-carousel__btn facility-carousel__button--next', false)
        ->assertDontSee('facility-carousel__button {', false)
